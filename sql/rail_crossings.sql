...
select
  a.watershed_group_code,
    case
     when a.watershed_group_code = 'OKAN' then 'COLUMBIA (OKANAGAN)'
     ...
     when a.watershed_group_code in ('BULK','KISP','KITR','KLUM','LKEL','LSKE','MORR','SUST') then 'SKEENA'
     when a.watershed_group_code in ('ALBN','COMX','COWN','PARK','VICT','WORC','SQAM') then 'COASTAL'
